...
public class RUSDemo extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        String strTitle = "This program demonstrates the use of Sentinel LDK licensing functions and the license update process.<br>Copyright (C) SafeNet, Inc. All rights reserved.<br><br>";
