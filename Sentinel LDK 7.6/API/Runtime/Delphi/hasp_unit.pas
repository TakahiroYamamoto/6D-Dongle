(******************************************************************************
*
* Sentinel Licensing API for Borland Delphi
*
...
function hasp_update ( update_data  : PAnsiChar;
                       var ack_data : PAnsiChar ) : hasp_status_t; stdcall;
...
{ Starting from Sentinel LDK version 6.0, the “hasp_detach” API has been deprecated. SafeNet recommends that user
should use the “hasp_transfer” API to perform the detach/cancel actions.
