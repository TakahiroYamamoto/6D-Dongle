...
public  class Activation {
	 ...
	 * @throws Exception
	 */
	public static void updateKeyWithLicense(String v2c,String vendorCode)throws Exception{
		Hasp hasp = new Hasp(Hasp.HASP_DEFAULT_FID);
		hasp.update(v2c);
		int status =  hasp.getLastError();
		if(status != HaspStatus.HASP_STATUS_OK){
			log.error("Error: updateKeyWithLicense Fails with status code "+status);
	 ...
	 * @throws Exception
	 */
	public static int register(String serverUrl,String jsessionId,Customer customer)throws Exception{
