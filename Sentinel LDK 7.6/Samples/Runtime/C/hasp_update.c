        ...
        if (status != HASP_STATUS_OK)
        {
            switch (status)
            {
                ...
                case HASP_TOO_MANY_PRODUCTS:
                    printf("Scope for hasp_detach does not select a unique "
                           "Parameter\n");
                    break;
                case HASP_ACCESS_DENIED:
                    printf("Request not possible because of ACC "
                                    "restrictions\n");
                    break;
        ...
        if (status != HASP_STATUS_OK)
        {
            switch (status)
            {
                ...
                case HASP_TOO_MANY_KEYS:
                     ...
                     break;
                case HASP_OLD_LM:
                     printf("\n LMS not supported to SL-AdminMode/SL-UserMode licenses\n");
                     break;
                case HASP_HASP_INACTIVE:
                     printf("\n Container is inactive\n");
                     break;
                case HASP_CLONE_DETECTED:
                     printf("\n Sentinel Clone Detected\n");
                     break;
                case HASP_REQ_NOT_SUPP:
                     printf("\n Rehost request supports  for SL-AdminMode/SL-UserMode licenses  \n");
                     break;
                default:
                    printf("hasp_transfer failed with status %u\n", status);
                    break;
