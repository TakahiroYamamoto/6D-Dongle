...
cl -MT -W3 -Fm -D_CRT_SECURE_NO_DEPRECATE ..\..\..\hasp_demo.c -Fehasp_demo.exe hasp_windows_demo.lib
@if errorlevel 1 exit 1

cl -MT -W3 -Fm -D_CRT_SECURE_NO_DEPRECATE ..\..\..\hasp_update.c -Fehasp_update.exe hasp_windows_demo.lib
@if errorlevel 1 exit 1

cl -MT -W3 -Fm -D_CRT_SECURE_NO_DEPRECATE ..\..\..\sntl_admin_demo.c -Fesntl_admin_demo.exe hasp_windows_demo.lib
@if errorlevel 1 exit 1
