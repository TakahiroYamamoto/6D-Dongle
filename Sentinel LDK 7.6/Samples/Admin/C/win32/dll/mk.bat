@rem
@rem Build sntl_adminapi_demo.exe using sntl_adminapi_windows.dll
@rem sntl_adminapi_windows.lib is an import library.
@rem
...
cl -MT -W3 -DWIN32 -D_CRT_SECURE_NO_DEPRECATE ..\..\sntl_adminapi_demo.c -Fesntl_adminapi_demo.exe sntl_adminapi_windows.lib
