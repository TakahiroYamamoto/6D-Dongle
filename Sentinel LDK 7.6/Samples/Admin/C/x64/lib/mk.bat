@rem
@rem Build sntl_adminapi_demo.exe using libsntl_adminapi_windows_x64.lib
@rem
...
cl -MT -W3 -DWIN32 -D_CRT_SECURE_NO_DEPRECATE ..\..\sntl_adminapi_demo.c -Fesntl_adminapi_demo.exe libsntl_adminapi_windows_x64.lib
