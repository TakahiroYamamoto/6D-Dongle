...
namespace DongleTool
{
    public partial class ProcessBurnDlg : Form
    {
        ...
        public ProcessBurnDlg(LicenseMiniManager licMgr, List<DongleListItem> dongleItems, List<int> productIdxs, string folderV2C)
        {
            InitializeComponent();
        ...
        public ProcessBurnDlg(LicenseMiniManager licMgr, List<DongleListItem> dongleItems)
        {
            InitializeComponent();
        ...
        void ThreadWorkBurnV2C()
        {
            ...
            foreach (DongleListItem dongleItem in dongleItems)
            {
                ...
                try
                {
                    ...
                    if (v2cData != "")
                    {
                        if (LicenseMiniManager.BurnToDongle(dongleItem.v2c_filename, v2cData, out errmsg) < 0)
                            throw new Exception();
                        Invoke(new Delegate_EventFromThread(this.EventFromThread), count, "");
                    }
