...
namespace DongleToolLib
{
    public partial class EnumDongleCtl : UserControl
    {
        ...
        // DongleManagerから使う場合はC2Vを読み込む必要があり、このデリゲートをセットする必要がある
        Dele_GetDongleInfo dele_GetDongleInfo;
        ...
        public void Init(LicenseMiniManager licenseMgr, Dele_GetDongleInfo dele_GetDongleInfo)
        {
        ...
        {
            string errmsg;
            List<DongleListItem> dongleItems = LicenseMiniManager.EnumDongle(dele_GetDongleInfo, out errmsg);
            if (dongleItems == null)
            {
